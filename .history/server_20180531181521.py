...
def index():
    ...
    return render_template("list_of_question.html", list_of_dictionaries=list_of_dictionaries, list_of_headers=list_of_headers, find_by_id = find_by_id)
...
def question(id):
    return render_template("question/<id>")
